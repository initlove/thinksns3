...
/*
	I add width&height here, as I want to have a large pic or detailed pic
 */
	public function getEventList($map='',$order='id DESC',$mid,$width=100,$height=100){
        ...
        if( !empty( $result['data'] )){
            ...
            foreach( $result['data'] as &$value ){
                ...
                $value['cover'] = getCover($value['coverId'],$width,$height);
                //计算待审核人数
  ...
  //           X('Notify')->send($fids,'event_add',$data, $eventMap['uid']);
    ...
    public function getHotList(){
    	...
    	foreach($event_ids as &$v){
            ...
            $v['coverId'] = getCover($v['coverId'],200,200);
    	}
    	return $event_ids;
    }
